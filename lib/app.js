...
var jobMiddleware = require('./job-middleware');
...
var init = exports.init = function (config) {
  ...
  app.get('/:org/:repo/', auth.requireReadAccess, jobMiddleware.forceLatestJob, routes_jobs.job);
  app.get('/:org/:repo/job-result/:job_id', auth.requireReadAccess, routes_jobs.job);
