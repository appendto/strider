...
{
  var from = from || "BrowserSwarm <hello@browserswarm.com>";
  var domain = domain || "browserswarm.com";
...
exports.send_test_ok = function(job, repo_config)
{
    ...
    var subject = "[BrowserSwarm] - " + display_name + " test success - " + job.id.substr(0,8);
...
{
    var display_name = repo_config.url.replace(/^.*com\//gi, '');
    var subject = "[BrowserSwarm] - " + display_name + " test failure - " + job.id.substr(0,8);
...
exports.notify_password_change = function (user) {
  ...
  var subject = "[BrowserSwarm] - Password Change Notification - "
...
exports.notify_email_change = function (user, old_email) {
  ...
  var current_time = new Date();
  var subject = "[BrowserSwarm] - Email Address Change Notification - " + current_time.getHours() + ":" + current_time.getMinutes() ;
...
exports.send_invite_collaborator_new_user = function(req, email, code, url) {
  ...
  var subject = "[BrowserSwarm] Invite to " + display_name;
  var to = email;
...
exports.notify_new_admin = function (user) {
  ...
  var current_time = new Date();
  var subject = "[BrowserSwarm] - New Admin  - " + user + " - " + current_time.getHours() + ":" + current_time.getMinutes() ;
